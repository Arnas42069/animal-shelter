...
VALUES
    ('admin1',      'admin1@test.local',      '$argon2id$v=19$m=65536,t=3,p=4$//OMCf7VHis7MgTbDiCklg$9j1rYzK+Y3WSC78JN4IXEv+//rZF6oXfUtGUc6/LMR4', 'admin',     TRUE, now()),
    ('admin2',      'admin2@test.local',      '$argon2id$v=19$m=65536,t=3,p=4$//OMCf7VHis7MgTbDiCklg$9j1rYzK+Y3WSC78JN4IXEv+//rZF6oXfUtGUc6/LMR4', 'admin',     TRUE, NULL),
    ('shelter1',    'shelter1@test.local',    '$argon2id$v=19$m=65536,t=3,p=4$//OMCf7VHis7MgTbDiCklg$9j1rYzK+Y3WSC78JN4IXEv+//rZF6oXfUtGUc6/LMR4', 'shelter',   TRUE, now()),
    ('shelter2',    'shelter2@test.local',    '$argon2id$v=19$m=65536,t=3,p=4$//OMCf7VHis7MgTbDiCklg$9j1rYzK+Y3WSC78JN4IXEv+//rZF6oXfUtGUc6/LMR4', 'shelter',   TRUE, NULL),
    ('volunteer1',  'volunteer1@test.local',  '$argon2id$v=19$m=65536,t=3,p=4$//OMCf7VHis7MgTbDiCklg$9j1rYzK+Y3WSC78JN4IXEv+//rZF6oXfUtGUc6/LMR4', 'volunteer', TRUE, now()),
    ('volunteer2',  'volunteer2@test.local',  '$argon2id$v=19$m=65536,t=3,p=4$//OMCf7VHis7MgTbDiCklg$9j1rYzK+Y3WSC78JN4IXEv+//rZF6oXfUtGUc6/LMR4', 'volunteer', TRUE, NULL),
    ('user1',       'user1@test.local',       '$argon2id$v=19$m=65536,t=3,p=4$//OMCf7VHis7MgTbDiCklg$9j1rYzK+Y3WSC78JN4IXEv+//rZF6oXfUtGUc6/LMR4', 'user',      TRUE, now()),
    ('user2',       'user2@test.local',       '$argon2id$v=19$m=65536,t=3,p=4$//OMCf7VHis7MgTbDiCklg$9j1rYzK+Y3WSC78JN4IXEv+//rZF6oXfUtGUc6/LMR4', 'user',      TRUE, NULL)
...
VALUES
('Happy Paws Shelter', 'A friendly shelter for dogs and cats', 'contact@happypaws.lt', '+37060000001', 'https://happypaws.lt', 'Gedimino pr. 1', 'Vilnius', '01103', 'Lithuania', TRUE, TRUE, (SELECT id FROM app_user WHERE username = 'shelter1')),
('Safe Haven Shelter', 'Rescue and adoption center for abandoned animals', 'info@safehaven.lt', '+37060000002', 'https://safehaven.lt', 'Laisvės al. 10', 'Kaunas', '44240', 'Lithuania', FALSE, TRUE, (SELECT id FROM app_user WHERE username = 'shelter2'))
ON CONFLICT DO NOTHING;
